...
public class S3ServiceImpl implements S3Service {
    ...
    public S3Service.ImageUploadResult uploadImage(String base64Image) {
        ...
        try {
            ...
            return new S3Service.ImageUploadResult(s3Url, "s3", fileName, false);
        } catch (Exception e) {
            ...
            try {
                ...
                return new S3Service.ImageUploadResult(localUrl, "local", fileName, true);
